...
export const dict = {
  en: {
    ...
    runSep: 'Run',
    runTip: 'Start the separation with the selected method, quality and device',
    lanesIdle:
      'Idle — pick method / quality / device, then press ▶ Run',
    laneMix: 'Mix',
    laneVocals: 'Vocals',
    laneDrums: 'Drums',
    laneBass: 'Bass',
  ...
  zh: {
    ...
    runSep: '运行',
    runTip: '以当前选择的方法 / 质量 / 设备开始分离',
    lanesIdle: '空闲 — 选择 方法 / 质量 / 设备 后按 ▶ 运行',
    laneMix: '混音',
    laneVocals: '人声',
    laneDrums: '鼓',
    laneBass: '贝斯',
